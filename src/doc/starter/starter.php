                ...
                <!--------DASHBOARD-->
                        <div class="col-md-11 mx-auto">
                            <div class="col-12 mt-4">
                                ...
                                <div class="alert alert-info bg-light text-dark border-0 mt-2" role="alert">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="alert alert-light bg-warning text-dark border-0" role="alert">
                                                            <strong>Nota. </strong> Eliminar usuarios puede causar diversos errores, lo recomendable es solo darles de baja cambiando su estado 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-7">
