...
<body class="bg-dark" >
                ...
                <div class="col-sm-10 col-md-6 col-lg-6 mx-auto ">
                    <div class="card ">
                        ...
                        <div id="mensaje2"></div>
                            ...
                            <input id="monto" name="monto" type="text" placeholder="Monto inicial de la caja" required onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
    ...
    ?>
    <!-- FIN DE SCRIPTS -->
    <script src="../../../inc/funciones/cajas/app.js"></script>
</body>
