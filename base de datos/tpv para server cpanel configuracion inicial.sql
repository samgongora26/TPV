...
-- Tiempo de generación: 24-04-2021 a las 01:10:34
...
(1, '1', 'Cliente general', 1234567890, 'CDMX', 'condesa', 'tiendita', 'cliente@tiendita.com', '2021-03-05');
...
--
ALTER TABLE `jornadas_trabajo`
  MODIFY `id_jornada` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `puestos`
  MODIFY `id_puesto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
